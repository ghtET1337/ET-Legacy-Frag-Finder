...
cl /nologo /Fe:dist\ETLFragFinder.exe build\windows\sqlite3.obj build\windows\etl_demo_parser.obj build\windows\idtech3_huffman.obj build\windows\app_storage.obj build\windows\clip_export.obj build\windows\realtime_capture.obj build\windows\clip_export_window.obj build\windows\realtime_capture_window.obj build\windows\win_main.obj build\windows\app.res /link /SUBSYSTEM:WINDOWS comctl32.lib comdlg32.lib shell32.lib ole32.lib uuid.lib gdi32.lib dwmapi.lib uxtheme.lib
if errorlevel 1 exit /b 1
cl /nologo /Fe:dist\etl-frag-cli.exe build\windows\sqlite3.obj build\windows\etl_demo_parser.obj build\windows\idtech3_huffman.obj build\windows\app_storage.obj build\windows\clip_export.obj build\windows\realtime_capture.obj build\windows\main_cli.obj
if errorlevel 1 exit /b 1
