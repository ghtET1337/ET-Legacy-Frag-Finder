...
The protocol parser was developed against the official ET: Legacy source code, especially the message structures in `src/qcommon/msg.c`, demo reader in `src/client/cl_demo.c`, and protocol definitions in `src/game/bg_public.h`.

ET: Legacy is distributed under the GNU General Public License v3.0. Official source: <https://github.com/etlegacy/etlegacy>.
