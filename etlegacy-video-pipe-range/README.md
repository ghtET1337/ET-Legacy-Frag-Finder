...
ET: Legacy Frag Finder 1.7.5 works with an unmodified ET: Legacy 2.83 or newer through the corrected stock time controller. The optional patch provides direct engine-side `serverTime` range control.
