...
"$compiler" -std=c++17 -O2 -Wall -Wextra -Wpedantic -Isrc \
  src/etl_demo_parser.cpp src/idtech3_huffman.cpp src/app_storage.cpp src/clip_export.cpp src/main_cli.cpp \
  build/sqlite3.o -ldl -pthread -o build/etl-frag-cli

"$compiler" -std=c++17 -O2 -Wall -Wextra -Wpedantic -Isrc \
  src/etl_demo_parser.cpp src/idtech3_huffman.cpp src/app_storage.cpp src/clip_export.cpp tests/test_frag_runs.cpp \
  build/sqlite3.o -ldl -pthread -o build/etl-frag-tests

"$compiler" -std=c++17 -O2 -Wall -Wextra -Wpedantic -Isrc \
  src/clip_export.cpp tests/test_clip_export.cpp \
